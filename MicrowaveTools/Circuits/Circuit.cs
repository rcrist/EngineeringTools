    ...
    public class Circuit
    {
        ...
        public void Traverse()
        {
            ...
            foreach (Comp comp in this.comps)
            {
                ...
                {
                    nodeCount++;
                    wire.Cin.N[1] = nodeCount;  // Assign output node - Cin.Nodes[1] - to input component - Cin
                    wire.Cout.N[0] = nodeCount; // Assign input node - Cout.Nodes[0] - to output component - Cout
                }
        ...
        public void AnalyzeCircuit(float f)
        {
            ...
            foreach (Comp comp in this.comps)
            {
                ...
                if (comp is InPort)
                {
                    extN[0] = comp.N[1]; // Nodes[1] is the output port of a 2-port component
                }
                if (comp is OutPort)
                {
                    extN[1] = comp.N[0]; // Nodes[0] is the input port of a 2-port component
                }
            }
