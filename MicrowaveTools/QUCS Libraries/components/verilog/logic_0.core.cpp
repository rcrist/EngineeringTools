/*
 * logic_0.core.cpp - device implementations for logic_0 module
 *
...
#include "logic_0.analogfunction.h"
#include "component.h"
#include "device.h"
#include "logic_0.core.h"

#ifndef CIR_logic_0
#define CIR_logic_0 -1
#endif
...
/* Device constructor. */
logic_0::logic_0() : circuit (1)
{
  type = CIR_logic_0;
}

/* Initialization of model. */
void logic_0::initModel (void)
{
...
void logic_0::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void logic_0::initVerilog (void)
{
...
void logic_0::loadVariables (void)
{
...
void logic_0::initializeModel (void)
{
}

/* Evaluate Verilog-AMS equations in instance initialization. */
void logic_0::initializeInstance (void)
{
}

/* Evaluate Verilog-AMS equations in initial step. */
void logic_0::initialStep (void)
{
}

/* Evaluate Verilog-AMS equations in final step. */
void logic_0::finalStep (void)
{
}

/* Evaluate Verilog-AMS equations in analog block. */
void logic_0::calcVerilog (void)
{

/* ----------------- evaluate verilog analog equations -------------------- */
_load_static_residual1(L0,(-LEVEL));
#if defined(_DERIVATE)
#endif
_load_static_residual1(L0,NP(L0));
#if defined(_DERIVATE)
_load_static_jacobian1(L0,L0,1.0);
#endif
...
void logic_0::saveOperatingPoints (void)
{
  // save global instance operating points
}

/* Load operating points. */
void logic_0::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void logic_0::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void logic_0::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void logic_0::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix logic_0::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (1);
...
void logic_0::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void logic_0::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void logic_0::initTR (void)
{
  setStates (2 * 1 * 1);
  initDC ();
}
...
void logic_0::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix logic_0::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (1);
