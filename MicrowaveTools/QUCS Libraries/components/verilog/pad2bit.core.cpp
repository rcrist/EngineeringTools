/*
 * pad2bit.core.cpp - device implementations for pad2bit module
 *
...
#include "pad2bit.analogfunction.h"
#include "component.h"
#include "device.h"
#include "pad2bit.core.h"

#ifndef CIR_pad2bit
#define CIR_pad2bit -1
#endif
...
/* Device constructor. */
pad2bit::pad2bit() : circuit (2)
{
  type = CIR_pad2bit;
}

/* Initialization of model. */
void pad2bit::initModel (void)
{
...
void pad2bit::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void pad2bit::initVerilog (void)
{
...
void pad2bit::loadVariables (void)
{
...
void pad2bit::saveOperatingPoints (void)
{
  // save global instance operating points
}

/* Load operating points. */
void pad2bit::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void pad2bit::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void pad2bit::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void pad2bit::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix pad2bit::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (2);
...
void pad2bit::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void pad2bit::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void pad2bit::initTR (void)
{
  setStates (2 * 2 * 2);
  initDC ();
}
...
void pad2bit::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix pad2bit::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (2);
