/*
 * DLS_nto1.core.cpp - device implementations for DLS_nto1 module
 *
...
#include "DLS_nto1.analogfunction.h"
#include "component.h"
#include "device.h"
#include "DLS_nto1.core.h"

#ifndef CIR_DLS_nto1
#define CIR_DLS_nto1 -1
#endif
...
/* Device constructor. */
DLS_nto1::DLS_nto1() : circuit (4)
{
  type = CIR_DLS_nto1;
}

/* Initialization of model. */
void DLS_nto1::initModel (void)
{
...
void DLS_nto1::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void DLS_nto1::initVerilog (void)
{
...
void DLS_nto1::loadVariables (void)
{
...
void DLS_nto1::initializeModel (void)
{
#if defined(_DYNAMIC)
#endif
{
...
void DLS_nto1::initializeInstance (void)
{
}

/* Evaluate Verilog-AMS equations in initial step. */
void DLS_nto1::initialStep (void)
{
}

/* Evaluate Verilog-AMS equations in final step. */
void DLS_nto1::finalStep (void)
{
}

/* Evaluate Verilog-AMS equations in analog block. */
void DLS_nto1::calcVerilog (void)
{

/* ----------------- evaluate verilog analog equations -------------------- */
_load_static_residual1(n1,((NP(Lin)>=(LEVEL/2))?(-1):0));
#if defined(_DERIVATE)
_load_static_jacobian1(n1,Lin,((NP(Lin)>=(LEVEL/2))?0.0:0.0));
#endif
...
#endif
#endif
_load_static_residual1(Lout,(-NP(n2)));
#if defined(_DERIVATE)
_load_static_jacobian1(Lout,n2,(-1.0));
#endif
_load_static_residual1(Lout,NP(Lout));
#if defined(_DERIVATE)
_load_static_jacobian1(Lout,Lout,1.0);
#endif
...
void DLS_nto1::saveOperatingPoints (void)
{
  // save global instance operating points
}

/* Load operating points. */
void DLS_nto1::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void DLS_nto1::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void DLS_nto1::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void DLS_nto1::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix DLS_nto1::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (4);
...
void DLS_nto1::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void DLS_nto1::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void DLS_nto1::initTR (void)
{
  setStates (2 * 4 * 4);
  initDC ();
}
...
void DLS_nto1::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix DLS_nto1::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (4);
