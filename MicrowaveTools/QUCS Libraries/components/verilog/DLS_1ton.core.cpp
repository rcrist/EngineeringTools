/*
 * DLS_1ton.core.cpp - device implementations for DLS_1ton module
 *
...
#include "DLS_1ton.analogfunction.h"
#include "component.h"
#include "device.h"
#include "DLS_1ton.core.h"

#ifndef CIR_DLS_1ton
#define CIR_DLS_1ton -1
#endif
...
/* Device constructor. */
DLS_1ton::DLS_1ton() : circuit (5)
{
  type = CIR_DLS_1ton;
}

/* Initialization of model. */
void DLS_1ton::initModel (void)
{
  // create internal nodes
  setInternalNode (n1, "n1");
  setInternalNode (n2, "n2");
  setInternalNode (Vout, "Vout");
...
void DLS_1ton::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void DLS_1ton::initVerilog (void)
{
...
void DLS_1ton::loadVariables (void)
{
...
void DLS_1ton::initializeModel (void)
{
#if defined(_DYNAMIC)
#endif
{
...
void DLS_1ton::initializeInstance (void)
{
}

/* Evaluate Verilog-AMS equations in initial step. */
void DLS_1ton::initialStep (void)
{
}

/* Evaluate Verilog-AMS equations in final step. */
void DLS_1ton::finalStep (void)
{
}

/* Evaluate Verilog-AMS equations in analog block. */
void DLS_1ton::calcVerilog (void)
{

/* ----------------- evaluate verilog analog equations -------------------- */
_load_static_residual1(n1,((NP(Lin)>=0.5)?(-LEVEL):0));
#if defined(_DERIVATE)
_load_static_jacobian1(n1,Lin,((NP(Lin)>=0.5)?0.0:0.0));
#endif
...
#endif
#endif
_load_static_residual1(Lout,NP(Vout));
#if defined(_DERIVATE)
_load_static_jacobian1(Lout,Vout,1.0);
#endif
_load_static_residual1(Vout,(NP(Lout)-NP(n2)));
#if defined(_DERIVATE)
_load_static_jacobian1(Vout,n2,(-1.0));
_load_static_jacobian1(Vout,Lout,1.0);
#endif
...
void DLS_1ton::saveOperatingPoints (void)
{
  // save global instance operating points
}

/* Load operating points. */
void DLS_1ton::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void DLS_1ton::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void DLS_1ton::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void DLS_1ton::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix DLS_1ton::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (5);
...
void DLS_1ton::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void DLS_1ton::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void DLS_1ton::initTR (void)
{
  setStates (2 * 5 * 5);
  initDC ();
}
...
void DLS_1ton::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix DLS_1ton::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (5);
