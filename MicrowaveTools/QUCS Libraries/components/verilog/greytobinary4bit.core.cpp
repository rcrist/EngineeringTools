/*
 * greytobinary4bit.core.cpp - device implementations for greytobinary4bit module
 *
...
#include "greytobinary4bit.analogfunction.h"
#include "component.h"
#include "device.h"
#include "greytobinary4bit.core.h"

#ifndef CIR_greytobinary4bit
#define CIR_greytobinary4bit -1
#endif
...
#define _modelname              "greytobinary4bit"
...
/* Device constructor. */
greytobinary4bit::greytobinary4bit() : circuit (16)
{
  type = CIR_greytobinary4bit;
}

/* Initialization of model. */
void greytobinary4bit::initModel (void)
{
  // create internal nodes
  setInternalNode (B0n1, "B0n1");
  setInternalNode (B0n2, "B0n2");
  setInternalNode (B1n1, "B1n1");
  setInternalNode (B1n2, "B1n2");
  setInternalNode (B2n1, "B2n1");
  setInternalNode (B2n2, "B2n2");
  setInternalNode (B3n1, "B3n1");
  setInternalNode (B3n2, "B3n2");
...
void greytobinary4bit::initDC (void)
{
  allocMatrixMNA ();
  initModel ();
  pol = 1;
...
void greytobinary4bit::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void greytobinary4bit::initVerilog (void)
{
...
void greytobinary4bit::loadVariables (void)
{
...
void greytobinary4bit::initializeModel (void)
{
#if defined(_DYNAMIC)
#endif
{
...
void greytobinary4bit::initializeInstance (void)
{
}

/* Evaluate Verilog-AMS equations in initial step. */
void greytobinary4bit::initialStep (void)
{
}

/* Evaluate Verilog-AMS equations in final step. */
void greytobinary4bit::finalStep (void)
{
}

/* Evaluate Verilog-AMS equations in analog block. */
void greytobinary4bit::calcVerilog (void)
{
...
#endif
#if defined(_DERIVATE)
m0_VG0_GND=(((1-NP(B1)))+(-1.0)*NP(B1));
m0_VB1_GND=((NP(G0)*(-1.0))+((1-NP(G0))));
#endif
m0=((NP(G0)*(1-NP(B1)))+((1-NP(G0))*NP(B1)));
#if defined(_DERIVATE)
m1_VG1_GND=(((1-NP(B2)))+(-1.0)*NP(B2));
m1_VB2_GND=((NP(G1)*(-1.0))+((1-NP(G1))));
#endif
m1=((NP(G1)*(1-NP(B2)))+((1-NP(G1))*NP(B2)));
#if defined(_DERIVATE)
m2_VG2_GND=(((1-NP(G3)))+(-1.0)*NP(G3));
m2_VG3_GND=((NP(G2)*(-1.0))+((1-NP(G2))));
#endif
m2=((NP(G2)*(1-NP(G3)))+((1-NP(G2))*NP(G3)));
#if defined(_DERIVATE)
m3_VG3_GND=1.0;
#endif
m3=NP(G3);
...
#endif
_load_static_residual1(B0n1,((-0.5)*(1+d00_tanh0)));
#if defined(_DERIVATE)
_load_static_jacobian1(B0n1,B1,((-0.5)*(TR*m0_VB1_GND)*d10_tanh0));
_load_static_jacobian1(B0n1,G0,((-0.5)*(TR*m0_VG0_GND)*d10_tanh0));
#endif
}
_load_static_residual1(B0n1,NP(B0n1));
#if defined(_DERIVATE)
_load_static_jacobian1(B0n1,B0n1,1.0);
#endif
_load_static_residual2(B0n1,B0n2,(BP(B0n1,B0n2)/Rd));
#if defined(_DERIVATE)
_load_static_jacobian4(B0n1,B0n2,B0n1,B0n2,(1/Rd));
#endif
#if defined(_DYNAMIC)
_load_dynamic_residual1(B0n2,_DDT((Cd*NP(B0n2))));
#if defined(_DERIVATE)
_load_dynamic_jacobian1(B0n2,B0n2,(Cd));
#endif
#endif
_load_static_residual1(B0,(-NP(B0n2)));
#if defined(_DERIVATE)
_load_static_jacobian1(B0,B0n2,(-1.0));
#endif
_load_static_residual1(B0,NP(B0));
#if defined(_DERIVATE)
_load_static_jacobian1(B0,B0,1.0);
#endif
{
...
#endif
_load_static_residual1(B1n1,((-0.5)*(1+d00_tanh0)));
#if defined(_DERIVATE)
_load_static_jacobian1(B1n1,B2,((-0.5)*(TR*m1_VB2_GND)*d10_tanh0));
_load_static_jacobian1(B1n1,G1,((-0.5)*(TR*m1_VG1_GND)*d10_tanh0));
#endif
}
_load_static_residual1(B1n1,NP(B1n1));
#if defined(_DERIVATE)
_load_static_jacobian1(B1n1,B1n1,1.0);
#endif
_load_static_residual2(B1n1,B1n2,(BP(B1n1,B1n2)/Rd));
#if defined(_DERIVATE)
_load_static_jacobian4(B1n1,B1n2,B1n1,B1n2,(1/Rd));
#endif
#if defined(_DYNAMIC)
_load_dynamic_residual1(B1n2,_DDT((Cd*NP(B1n2))));
#if defined(_DERIVATE)
_load_dynamic_jacobian1(B1n2,B1n2,(Cd));
#endif
#endif
_load_static_residual1(B1,(-NP(B1n2)));
#if defined(_DERIVATE)
_load_static_jacobian1(B1,B1n2,(-1.0));
#endif
_load_static_residual1(B1,NP(B1));
#if defined(_DERIVATE)
_load_static_jacobian1(B1,B1,1.0);
#endif
{
...
#endif
_load_static_residual1(B2n1,((-0.5)*(1+d00_tanh0)));
#if defined(_DERIVATE)
_load_static_jacobian1(B2n1,G3,((-0.5)*(TR*m2_VG3_GND)*d10_tanh0));
_load_static_jacobian1(B2n1,G2,((-0.5)*(TR*m2_VG2_GND)*d10_tanh0));
#endif
}
_load_static_residual1(B2n1,NP(B2n1));
#if defined(_DERIVATE)
_load_static_jacobian1(B2n1,B2n1,1.0);
#endif
_load_static_residual2(B2n1,B2n2,(BP(B2n1,B2n2)/Rd));
#if defined(_DERIVATE)
_load_static_jacobian4(B2n1,B2n2,B2n1,B2n2,(1/Rd));
#endif
#if defined(_DYNAMIC)
_load_dynamic_residual1(B2n2,_DDT((Cd*NP(B2n2))));
#if defined(_DERIVATE)
_load_dynamic_jacobian1(B2n2,B2n2,(Cd));
#endif
#endif
_load_static_residual1(B2,(-NP(B2n2)));
#if defined(_DERIVATE)
_load_static_jacobian1(B2,B2n2,(-1.0));
#endif
_load_static_residual1(B2,NP(B2));
#if defined(_DERIVATE)
_load_static_jacobian1(B2,B2,1.0);
#endif
{
...
#endif
_load_static_residual1(B3n1,((-0.5)*(1+d00_tanh0)));
#if defined(_DERIVATE)
_load_static_jacobian1(B3n1,G3,((-0.5)*(TR*m3_VG3_GND)*d10_tanh0));
#endif
}
_load_static_residual1(B3n1,NP(B3n1));
#if defined(_DERIVATE)
_load_static_jacobian1(B3n1,B3n1,1.0);
#endif
_load_static_residual2(B3n1,B3n2,(BP(B3n1,B3n2)/Rd));
#if defined(_DERIVATE)
_load_static_jacobian4(B3n1,B3n2,B3n1,B3n2,(1/Rd));
#endif
#if defined(_DYNAMIC)
_load_dynamic_residual1(B3n2,_DDT((Cd*NP(B3n2))));
#if defined(_DERIVATE)
_load_dynamic_jacobian1(B3n2,B3n2,(Cd));
#endif
#endif
_load_static_residual1(B3,(-NP(B3n2)));
#if defined(_DERIVATE)
_load_static_jacobian1(B3,B3n2,(-1.0));
#endif
_load_static_residual1(B3,NP(B3));
#if defined(_DERIVATE)
_load_static_jacobian1(B3,B3,1.0);
#endif
...
void greytobinary4bit::calcDC (void)
{
...
void greytobinary4bit::saveOperatingPoints (void)
{
  // save global instance operating points
}

/* Load operating points. */
void greytobinary4bit::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void greytobinary4bit::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void greytobinary4bit::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void greytobinary4bit::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix greytobinary4bit::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (16);
...
void greytobinary4bit::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void greytobinary4bit::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void greytobinary4bit::initTR (void)
{
  setStates (2 * 16 * 16);
  initDC ();
}
...
void greytobinary4bit::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix greytobinary4bit::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (16);
...
/* Perform HB analysis. */
void greytobinary4bit::calcHB (int)
{
  doHB = 1;
  doAC = 1;
  doTR = 0;
...
#include "greytobinary4bit.defs.h"
