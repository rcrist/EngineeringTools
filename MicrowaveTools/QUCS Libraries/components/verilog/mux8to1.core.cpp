/*
 * mux8to1.core.cpp - device implementations for mux8to1 module
 *
...
#include "component.h"
#include "device.h"
#include "mux8to1.core.h"

#ifndef CIR_mux8to1
#define CIR_mux8to1 -1
#endif
...
/* Device constructor. */
mux8to1::mux8to1() : circuit (15)
{
  type = CIR_mux8to1;
}

/* Initialization of model. */
void mux8to1::initModel (void)
{
...
void mux8to1::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void mux8to1::initVerilog (void)
{
...
void mux8to1::loadVariables (void)
{
...
void mux8to1::initializeModel (void)
{
#if defined(_DYNAMIC)
#endif
{
...
VCI=(1-NP(C));
#if defined(_DERIVATE)
m0_VD0_GND=(VCI)*VBI*VAI;
m0_VC_GND=(NP(D0)*VCI_VC_GND)*VBI*VAI;
m0_VB_GND=((NP(D0)*VCI)*VBI_VB_GND)*VAI;
m0_VA_GND=(((NP(D0)*VCI)*VBI)*VAI_VA_GND);
#endif
m0=(((NP(D0)*VCI)*VBI)*VAI);
#if defined(_DERIVATE)
m1_VD1_GND=(VCI)*VBI*NP(A);
m1_VC_GND=(NP(D1)*VCI_VC_GND)*VBI*NP(A);
m1_VB_GND=((NP(D1)*VCI)*VBI_VB_GND)*NP(A);
m1_VA_GND=(((NP(D1)*VCI)*VBI));
#endif
m1=(((NP(D1)*VCI)*VBI)*NP(A));
#if defined(_DERIVATE)
m2_VD2_GND=(VCI)*NP(B)*VAI;
m2_VC_GND=(NP(D2)*VCI_VC_GND)*NP(B)*VAI;
m2_VB_GND=((NP(D2)*VCI))*VAI;
m2_VA_GND=(((NP(D2)*VCI)*NP(B))*VAI_VA_GND);
#endif
m2=(((NP(D2)*VCI)*NP(B))*VAI);
#if defined(_DERIVATE)
m3_VD3_GND=(VCI)*NP(B)*NP(A);
m3_VC_GND=(NP(D3)*VCI_VC_GND)*NP(B)*NP(A);
m3_VB_GND=((NP(D3)*VCI))*NP(A);
m3_VA_GND=(((NP(D3)*VCI)*NP(B)));
#endif
m3=(((NP(D3)*VCI)*NP(B))*NP(A));
#if defined(_DERIVATE)
m4_VD4_GND=(NP(C))*VBI*VAI;
m4_VC_GND=(NP(D4))*VBI*VAI;
m4_VB_GND=((NP(D4)*NP(C))*VBI_VB_GND)*VAI;
m4_VA_GND=(((NP(D4)*NP(C))*VBI)*VAI_VA_GND);
#endif
m4=(((NP(D4)*NP(C))*VBI)*VAI);
#if defined(_DERIVATE)
m5_VD5_GND=(NP(C))*VBI*NP(A);
m5_VC_GND=(NP(D5))*VBI*NP(A);
m5_VB_GND=((NP(D5)*NP(C))*VBI_VB_GND)*NP(A);
m5_VA_GND=(((NP(D5)*NP(C))*VBI));
#endif
m5=(((NP(D5)*NP(C))*VBI)*NP(A));
#if defined(_DERIVATE)
m6_VD6_GND=(NP(C))*NP(B)*VAI;
m6_VC_GND=(NP(D6))*NP(B)*VAI;
m6_VB_GND=((NP(D6)*NP(C)))*VAI;
m6_VA_GND=(((NP(D6)*NP(C))*NP(B))*VAI_VA_GND);
#endif
m6=(((NP(D6)*NP(C))*NP(B))*VAI);
#if defined(_DERIVATE)
m7_VD7_GND=(NP(C))*NP(B)*NP(A);
m7_VC_GND=(NP(D7))*NP(B)*NP(A);
m7_VB_GND=((NP(D7)*NP(C)))*NP(A);
m7_VA_GND=(((NP(D7)*NP(C))*NP(B)));
#endif
m7=(((NP(D7)*NP(C))*NP(B))*NP(A));
#if defined(_DERIVATE)
In1_VEN_GND=(-1.0)*(((((((m0+m1)+m2)+m3)+m4)+m5)+m6)+m7);
In1_VD0_GND=((1-NP(EN))*m0_VD0_GND);
In1_VC_GND=((1-NP(EN))*(((((((m0_VC_GND+m1_VC_GND)+m2_VC_GND)+m3_VC_GND)+m4_VC_GND)+m5_VC_GND)+m6_VC_GND)+m7_VC_GND));
In1_VB_GND=((1-NP(EN))*(((((((m0_VB_GND+m1_VB_GND)+m2_VB_GND)+m3_VB_GND)+m4_VB_GND)+m5_VB_GND)+m6_VB_GND)+m7_VB_GND));
In1_VA_GND=((1-NP(EN))*(((((((m0_VA_GND+m1_VA_GND)+m2_VA_GND)+m3_VA_GND)+m4_VA_GND)+m5_VA_GND)+m6_VA_GND)+m7_VA_GND));
In1_VD1_GND=((1-NP(EN))*m1_VD1_GND);
In1_VD2_GND=((1-NP(EN))*m2_VD2_GND);
In1_VD3_GND=((1-NP(EN))*m3_VD3_GND);
In1_VD4_GND=((1-NP(EN))*m4_VD4_GND);
In1_VD5_GND=((1-NP(EN))*m5_VD5_GND);
In1_VD6_GND=((1-NP(EN))*m6_VD6_GND);
In1_VD7_GND=((1-NP(EN))*m7_VD7_GND);
#endif
In1=((1-NP(EN))*(((((((m0+m1)+m2)+m3)+m4)+m5)+m6)+m7));
{
...
#if defined(_DERIVATE)
_load_static_jacobian1(n1,D7,((-0.5)*(TR*In1_VD7_GND)*d10_tanh0));
_load_static_jacobian1(n1,D6,((-0.5)*(TR*In1_VD6_GND)*d10_tanh0));
_load_static_jacobian1(n1,D5,((-0.5)*(TR*In1_VD5_GND)*d10_tanh0));
_load_static_jacobian1(n1,D4,((-0.5)*(TR*In1_VD4_GND)*d10_tanh0));
_load_static_jacobian1(n1,D3,((-0.5)*(TR*In1_VD3_GND)*d10_tanh0));
_load_static_jacobian1(n1,D2,((-0.5)*(TR*In1_VD2_GND)*d10_tanh0));
_load_static_jacobian1(n1,D1,((-0.5)*(TR*In1_VD1_GND)*d10_tanh0));
_load_static_jacobian1(n1,A,((-0.5)*(TR*In1_VA_GND)*d10_tanh0));
_load_static_jacobian1(n1,B,((-0.5)*(TR*In1_VB_GND)*d10_tanh0));
_load_static_jacobian1(n1,C,((-0.5)*(TR*In1_VC_GND)*d10_tanh0));
...
void mux8to1::saveOperatingPoints (void)
{
  // save global instance operating points
}

/* Load operating points. */
void mux8to1::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void mux8to1::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void mux8to1::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void mux8to1::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix mux8to1::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (15);
...
void mux8to1::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void mux8to1::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void mux8to1::initTR (void)
{
  setStates (2 * 15 * 15);
  initDC ();
}
...
void mux8to1::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix mux8to1::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (15);
