/*
 * logic_1.core.cpp - device implementations for logic_1 module
 *
...
#include "logic_1.analogfunction.h"
#include "component.h"
#include "device.h"
#include "logic_1.core.h"

#ifndef CIR_logic_1
#define CIR_logic_1 -1
#endif
...
/* Device constructor. */
logic_1::logic_1() : circuit (1)
{
  type = CIR_logic_1;
}

/* Initialization of model. */
void logic_1::initModel (void)
{
...
void logic_1::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void logic_1::initVerilog (void)
{
...
void logic_1::loadVariables (void)
{
...
void logic_1::initializeModel (void)
{
}

/* Evaluate Verilog-AMS equations in instance initialization. */
void logic_1::initializeInstance (void)
{
}

/* Evaluate Verilog-AMS equations in initial step. */
void logic_1::initialStep (void)
{
}

/* Evaluate Verilog-AMS equations in final step. */
void logic_1::finalStep (void)
{
}

/* Evaluate Verilog-AMS equations in analog block. */
void logic_1::calcVerilog (void)
{

/* ----------------- evaluate verilog analog equations -------------------- */
_load_static_residual1(L1,(-LEVEL));
#if defined(_DERIVATE)
#endif
_load_static_residual1(L1,NP(L1));
#if defined(_DERIVATE)
_load_static_jacobian1(L1,L1,1.0);
#endif
...
void logic_1::saveOperatingPoints (void)
{
  // save global instance operating points
}

/* Load operating points. */
void logic_1::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void logic_1::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void logic_1::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void logic_1::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix logic_1::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (1);
...
void logic_1::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void logic_1::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void logic_1::initTR (void)
{
  setStates (2 * 1 * 1);
  initDC ();
}
...
void logic_1::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix logic_1::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (1);
